...
(function (a, b) {
    ...
    var d = function (j) {
    ...
    }(), g = d.default || window.jQuery || window.$, h = function () {
        function j(k) {
            var l = this, m = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
            ...
            }), this.$container = g('<div>', {class: this._getClass('container')}), this.$on = g('<span>', {
        ...
        return f(j, [{
            ...
            key: 'toggleState', value: function (l) {
            ...
            key: 'indeterminate', value: function (l) {
            ...
            key: 'toggleInverse', value: function () {
                ...
                var l = this.$on.clone(!0), m = this.$off.clone(!0);
            ...
            key: 'labelWidth', value: function (l) {
            ...
            key: 'baseClass', value: function () {
                return this.options.baseClass
            }
        }, {
            key: 'wrapperClass', value: function (l) {
            ...
            key: 'radioAllOff', value: function (l) {
            ...
            key: 'onSwitchChange', value: function (l) {
            ...
            key: '_width', value: function () {
                var l = this, m = this.$on.add(this.$off).add(this.$label).css('width', ''), n = 'auto' === this.options.handleWidth ? Math.round(Math.max(this.$on.width(), this.$off.width())) : this.options.handleWidth;
            ...
            key: '_containerPosition', value: function () {
                var l = this, m = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.options.state, n = arguments[1];
            ...
            key: '_externalLabelHandler', value: function () {
                var l = this, m = this.$element.closest('label');
            ...
            key: '_getClass', value: function (l) {
                return this.options.baseClass + '-' + l
            }
        }, {
            key: '_getClasses', value: function (l) {
    ...
    g.fn.bootstrapSwitch = function (j) {
        ...
        return Array.prototype.reduce.call(this, function (o, p) {
            var q = g(p), r = q.data('bootstrap-switch'), s = r || new h(p, j);
